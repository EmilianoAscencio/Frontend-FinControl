  ...
  <div class="auth-shell">
    ...
    <div class="brand-panel" aria-hidden="true">
      <div class="brand-content">
        ...
        <h1 class="brand-headline">Empieza en<br>minutos</h1>
        <p class="brand-sub">Crea tu cuenta gratis y comienza a controlar tus finanzas hoy mismo.</p>
        <div class="brand-features">
          <div class="feat">✓ Sin tarjeta de crédito requerida</div>
          <div class="feat">✓ Acceso inmediato al dashboard</div>
          <div class="feat">✓ Categorías predefinidas incluidas</div>
          <div class="feat">✓ Exporta tus datos en CSV</div>
        </div>
      </div>
      ...
      <div class="form-card">
        ...
        <div class="form-head">
          <div class="mobile-logo">
            ...
            <span class="brand-name-sm">FinControl</span>
          </div>
          <h2>Crear cuenta</h2>
          <p class="form-sub">Completa los datos para comenzar</p>
        </div>
...
.brand-name-sm { font-size: 15px; font-weight: 700; color: var(--text-h); }
.brand-headline { font-size: 32px; font-weight: 700; color: #fff; line-height: 1.25; margin: 0; }
.brand-sub      { font-size: 15px; color: rgba(255,255,255,0.78); margin: 0; line-height: 1.6; }
.brand-features { display: flex; flex-direction: column; gap: 10px; margin-top: 4px; }
.feat           { font-size: 14px; color: rgba(255,255,255,0.85); }
.brand-pattern { position: absolute; inset: 0; pointer-events: none; overflow: hidden; }
.brand-svg     { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }

.form-panel {
  display: flex; align-items: center; justify-content: center;
  flex: 1; background: var(--bg); padding: 24px 16px;
}
...
.input-wrap input {
  ...
  color: var(--text-h); font-size: 14px; outline: none;
...
.pass-toggle {
  ...
  font-size: 14px; color: var(--text); padding: 2px;
}
...
.error-msg {
  ...
  border-radius: 8px; border: 1px solid rgba(220,38,38,0.18);
}
